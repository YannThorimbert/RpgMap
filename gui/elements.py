...
class CellInfo:
    ...
    def __init__(self, me, size, cell_size, redraw, external_e):
        ...
        self.e_coord_name = thorpy.make_text("Coord :", 12, (50,50,50))
        self.e_coordalt = thorpy.make_text("(?,?)", font_size=12, font_color=(50,50,50))
        self.e_group_coord = thorpy.make_group([self.e_coord_name, self.e_coordalt])
        self.e_chunk_name = thorpy.make_text("Chunk :", 12, (50,50,50))
        self.e_chunk = thorpy.make_text("(?,?)", font_size=12, font_color=(50,50,50))
        self.e_group_chunk = thorpy.make_group([self.e_chunk_name, self.e_chunk])
...
##        self.e_mat.fit_children(axis=(False, True))
        self.elements = [self.e_mat, self.e_group_coord, self.e_group_chunk]
...
##        self.e_coordalt.recenter()
        ...
        thorpy.store(self.e)
##        thorpy.get_screen().fill((0,0,255))
##        self.e.blit()
##        pygame.draw.rect(thorpy.get_screen(), (0,0,0), self.e_coordalt.get_fus_rect())
##        pygame.display.flip()
