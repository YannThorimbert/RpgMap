...
#differencier les objets statiques uniframe des objets statiques multiframes... (majorité est uniframe!)
    #de plus, pour les arbres, on va plutot faire un bouge feuille aléatoire, avec un reblit d'une cellule de temps à autres
